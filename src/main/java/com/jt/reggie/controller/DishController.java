...
import com.jt.reggie.entity.DishFlavor;
import com.jt.reggie.service.CategoryService;
import com.jt.reggie.service.DishFlavorService;
...
//        redisTemplate.delete(keys);
    ...
    public R<List<DishDto>> list(Dish dish){
        ...
        //动态构造key
        String key = "dish_" + dish.getCategoryId() + "_" + dish.getStatus();//dish_123456341534135_1
